...
const nav: [string, string][] = [["Home", "/"], ["Produk", "/produk"], ["Kategori", "/#kategori"], ["Promo", "/produk?promo=1"], ["Tentang Kami", "/tentang-kami"], ["Kontak", "/kontak"]];
      ...
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <details className="md:hidden relative">
            ...
            <div className="absolute right-0 top-10 w-52 bg-charcoal border border-gold/30 rounded-lg p-2">
